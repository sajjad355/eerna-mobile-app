...
Route::group(['middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin|salescenter|servicepoint']], function () {
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin|servicepoint|callcenter']], function () {
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin|admin|subadmin']], function () {
    ...
    Route::get('/head_office', 'ReportController@head_office')->name('head');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin']], function () {
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin|insurance|admin|subadmin']], function () {
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin|admin|subadmin|insurance']], function () {
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin|admin|insurance|servicepoint|subadmin|callcenter']], function () {
    Route::get('/date_wise_claim_search', 'ReportController@get_date_wise_claim_report')->name('date_wise_claim_search');
    Route::post('/date_wise_claim_search', 'ReportController@date_wise_claim_report_search')->name('date_wise_claim_report');
    Route::post('/insServiceImageDisplay', 'ReportController@ins_display_image')->name('ins_display_service_image');
});

Route::group(['middleware' => ['auth', 'XSS', 'revalidate', 'role:supadmin|salescenter|callcenter|servicepoint']], function () {
